...
model1 = RepressilatorSA(parameter_values, np.array(["transcription", "transcription", "hill", "translation", "rna_degradation", "protein_degradation", "Kd", "ar_factor"]), np.array([0, 0, 10, 150, 0, 0]), mode=0) 
model2 = RepressilatorSA(parameter_values, np.array(["transcription", "transcription", "hill", "translation", "rna_degradation", "protein_degradation", "Kd", "ar_factor"]), np.array([0, 0, 10, 150, 0, 0]), mode=1) 
