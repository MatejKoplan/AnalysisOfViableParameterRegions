...
from repressilator_backrepressing import RepressilatorBR
...
folder1 = path.join(".", "repressilatorBRCostOne", "exper0")      
...
numSamples = 9
if readFromFile:
	sampleNumbers2 = pickle.load(open("stochastic_samples_numbers_repressilatorBR", "rb"))
else:
	num2 = region2.shape[0]  
	sampleNumbers2 = np.random.choice(num2, numSamples, replace=False)   
	pickle.dump(sampleNumbers2, open("stochastic_samples_numbers_repressilatorBR", "wb+"))    
	
#plot few simulations (ode + ssa)
t = np.linspace(0, model2.T, model2.N)
if readFromFile:
	samples = pickle.load(open("stochastic_samples_repressilatorBR","rb"))     
else:	
	samples = region2[sampleNumbers2,:]
	pickle.dump(samples, open("stochastic_samples_repressilatorBR", "wb+"))   
...
if readFromFile:
	t_total_ode, Y_total_ode, ts_total_stochastic, Y_total_stochastic = pickle.load(open("stochastic_simulations_repressilatorBR", "rb"))  
...
if not readFromFile:
	pickle.dump((t_total_ode, Y_total_ode, ts_total_stochastic, Y_total_stochastic) ,open("stochastic_simulations_repressilatorBR", "wb+"))       	
...
if readFromFile:
	pers, amps = pickle.load(open("stochastic_persamps_repressilatorBR","rb")) 
...
if not readFromFile:	
	pickle.dump((pers, amps), open("stochastic_persamps_repressilatorBR", "wb+"))  
